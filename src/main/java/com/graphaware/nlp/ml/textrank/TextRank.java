...
public class TextRank {
    ...
    public boolean evaluate(Node annotatedText, int iter, double damp, double threshold) {
        ...
        while (!keywordsOccurrences.isEmpty()) {
            ...
            final AtomicReference<TfIdfObject> currTfIdf = new AtomicReference<>(tfidfMap != null && tfidfMap.containsKey(keywordOccurrence.get().getTagId()) ?
                                                                tfidfMap.get(keywordOccurrence.get().getTagId()) : new TfIdfObject(1.0d, 1.0d));
