...
public class EventDispatcherTest {
    ...
    public void testEventsAreReceivedFromDispatcher() {
        ...
        eventDispatcher.notify(Events.POST_TEXT_ANNOTATION, new GenericEvent(TEXT1, "hello"));
    }
    ...
    public void testEventListenersAreNotifiedInOrder() {
        ...
        eventDispatcher.notify(Events.POST_TEXT_ANNOTATION, new GenericEvent("hello", "1"));
